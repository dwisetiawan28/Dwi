 ...
 * @author user
 */
public class Form_Manajemenbarang extends javax.swing.JFrame {

    /**
     * Creates new form Form_Login
     */
    public Form_Manajemenbarang() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Manajemenbarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_Manajemenbarang().setVisible(true);
            }
        });
    }
