 ...
 * @author user
 */
public class Form_Manajemensupplier extends javax.swing.JFrame {

    /**
     * Creates new form Form_Login
     */
    public Form_Manajemensupplier() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Manajemensupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_Manajemensupplier().setVisible(true);
            }
        });
    }
